    ...
    emailjs
      ...
      .then(
        ...
        (err) => {
          ...
          console.log(JSON.stringify(import.meta.env.VITE_EMAILJS_TEMPLATE_ID));
          console.log(JSON.stringify(import.meta.env.VITE_EMAILJS_SERVICE_ID));
          console.log(JSON.stringify(import.meta.env.VITE_EMAILJS_PUBLIC_KEY));
